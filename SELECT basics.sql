...
-- 1. 단일 컬럼 선택
-- SELECT [column 명] FROM [table 명] WHERE [column 명] = [VALUE]
...
-- 2. 다중 컬럼 선택, IN 조건
-- SELECT [column 명], [column 명] FROM [table 명] WHERE [column 명] IN [(VALUE1, VALUE2, ...)]
...
-- 3. BETWEEN 조건
-- SELECT [column 명] FROM [table 명] WHERE [column 명] BETWEEN [VALUE1] AND [VALUE2]
